...
export default function ViewItem() {
        ...
        return (
            ...
            <div className="EditItemsWrapper">
                 ...
                 <div className="Info" id="HistoryInfo">
                            <h3>History</h3>
                    </div>
                    ...
                    <HistoryComponent
                       ...
                       receivedDate ="25-05-20"
                       receipientId ="Receipient Id:"
                       receipient ="Berlin"
                       commentsText="Comments:"
                       comments="Was received in a good condition and everything is fine and it works as expected"
                       receiver ="Receiver:"
                       receiverName = "Prince Adegah"
                    ...
                    <p id="edit-Items"><a href="">See more</a></p>
                 ...
                 <div className="Info">
                     ...
                     <div id="Assignee" className="prodImg">
                        
                     </div>

                     <div className="inchargeDetails">
                         <h4>Name: <span>Justice Ajah</span></h4>
                         <h4>Department: <span>Software Testing</span></h4>
                         <h4>Position: <span>Head of Humanitarian Affairs</span></h4>
                         <h4>Email: <span><a href="mailto:Justice.Ajah@amalitech.org">Justice.Ajah@amalitech.org</a></span></h4>
                     </div>
